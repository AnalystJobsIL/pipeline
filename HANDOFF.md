...
| 2026-09-19 | infra | **28 of 28 at JOB level.** `tests.yml` `35417787352` on `f794edb`, `queued` at 03:10Z — UNVERIFIED until read; a red naming `stale-*` is mine | | |
...
- **2026-09-19 `infra`** — no Chromium in the digest, so jd-text's render rung latched `render-unavailable`: 0 rows a night. Playwright step (+28 s, budgets 358/360) + cap 5. `635`: one `health.one_night_reading`, both consumers; 0 of 109 skipped today. CI `35417787352`. **NOT finished:** `638`, `604`. Record: `docs/sessions/2026-09-19-infra.md`.
