...
- **2026-08-30 `jd-text`** - the inline filler was never idle: **128/146, 132/164, 132/167** a morning, into `matched` not the caches. `linkedin no-markers` is HONEST; the Unlocker reads those pages raw, so it may now buy (**9 of 10**) - INERT until infra applies 448. **UNVERIFIED IN CI**: `guard` cancels at its 10-min timeout (442). `docs/sessions/2026-08-30-jd-text.md`. **NOT done:** 445-448, 456.
