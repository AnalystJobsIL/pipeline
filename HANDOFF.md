...
- **2026-08-24 → 2026-08-31, 57 session lines, ten lanes** — folded to pointers (338, 361; `infra` (b), `docs` (c) by `scraper`; `classifier` (b), `render` (b), `company-intel` (b) and `scraper` by `company-intel`, all at the word cap). Records: `docs/sessions/2026-08-*.md`; `registry` (d) in `2026-08-30-infra-b.md` §0. NOT finished: 491/501/502, 464/116/503/504, 505-506, 507/508, 500@roles. `docs` (c) CI `3453a2a` 33329623016 `success` 13/13.
...
- **2026-08-31 `company-intel`** — the backlog was built out of the EMPTY STRING: the bulk pass asked `research_company(name, "")`, so 21 names struck `could not identify`, re-asked every retry. Two anchors now; a transient blurb no longer skips research; `nvidia ai`→`nvidia`. **NOT finished:** _pending_. Record: `docs/sessions/2026-08-31-company-intel.md`.
