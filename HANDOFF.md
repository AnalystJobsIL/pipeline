...
- **2026-08-28/29 `registry`** - master was red on THREE tests, none the one both backlog items name, and that transition is LEGITIMATE. Searched queue drain 2.2% -> 12.7%, 56 rows. **Waves 2/3 found 4 unsound `confirmed` verdicts of mine (stripped) and `Agency`/Meridial ACTIVE from a cron.** **NOT finished:** 398-420. Record: `docs/sessions/2026-08-28-registry-evening.md`.
