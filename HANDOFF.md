...
- **2026-08-31 `company-intel` (a+b)** — anchors were not enough: a live role is never "not an employer" (`Oak` was). One `evidence_context`; a url buys one ask about the POSTING. **28 → 4 → 0**, unmatched 3→0; `521`/`525` closed, `539` filed; a wave took back 4 product defects. CI <PENDING>. **NOT finished:** 09-01 proof, `538`. Record: `docs/sessions/2026-08-31-company-intel-b.md`.
