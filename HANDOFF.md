...
- **2026-08-27 `registry`** — `activation_ok` admitted 9 of 12 boards guessed from a company name, 6 of them another employer's: a slug made from the name near-equals the name. Shipped a free rung gated on `il>=1` (20 of 498) and a queue drain (1,693 -> 498). **NOT finished:** 317-319. Record: `docs/sessions/2026-08-27-registry.md`.
