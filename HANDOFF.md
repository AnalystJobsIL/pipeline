...
- **2026-09-18 `company-intel`** — three employers held two firmographics records each, and one brand arrived with a blurb about a Canadian company. `ALIASES` flare/trivago, `alias_only_folds` (`618`), `DISPLAY_NAME_OVERRIDES["Holisto"]`; export **1,704→1,701**, +2 display names. Group19 sector CONFIRMED; the board is `633`. Seam **1**, BD **0**. CI `RUNID`. **NOT finished:** `632`, `633`. Record: `docs/sessions/2026-09-18-company-intel.md`.
