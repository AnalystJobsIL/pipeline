...
- **2026-08-31 `company-intel` (b)** — slugs shipped as employer names. `display_name`, evidence-only, re-derived at every union/publish (opus waves cut the first 104), divergents refused, 4-row override table; sectors case-folded (482 closed). **NOT finished:** 505-506; 09-01 digest = combined proof with `render`. Record: `docs/sessions/2026-08-30-company-intel-b.md`.
