...
- **2026-08-29 `registry` (queue)** - the queue could not say what had been TRIED: 393 of 877 were in no state file. `queue_state.py` gives a NAME a verdict, a date and a pool; all 877 accounted for. `resolve_llm` 0% -> **7.3%** given a verified own-domain. **NOT finished:** 422, 423. Record: `docs/sessions/2026-08-29-registry-queue.md`.
