...
- **2026-08-30 `registry` (c)** - the queue refilled 210 -> 572 in a day; the drain never read the ledger. Capacity **112/night vs intake 161 median / 212 mean** (`491@infra`). Comcast + 19 query-URL rows parked. CI 33312937940 `failure`: guard/guard-kill/gates 1-2 green, worst/1 inherited, **gate 0 timed out** (`491` item 5). **NOT finished:** 491-493, the unattended run. Record: `docs/sessions/2026-08-30-registry-c.md`.
- **2026-08-30 `discovery`** — "sitemap carries the domain" was false; four sources costed, **wire nothing**. **483 built:** catalog cap 40/DAY, idempotent. **NOT finished:** 484-486, 494-495, unattended `day window 40` proof. `docs/sessions/2026-08-30-discovery.md`.
