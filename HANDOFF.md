...
- **2026-08-30 `registry` (c)** - the queue refilled 210 -> 572 in a day while a session drained it; the drain never read the ledger and ran oldest-first. Capacity **112/night vs intake 161 median / 212 mean** (`491@infra`). Comcast + 19 query-URL rows parked; every activation path refuses stamped cards. **NOT finished:** 491-493, the unattended run. Record: `docs/sessions/2026-08-30-registry-c.md`.
