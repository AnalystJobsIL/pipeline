...
- **2026-08-28/29 `registry`** - the red was a LEGITIMATE transition, not erosion. Zero audit 215 -> 7: **68 "empty" verdicts overturned** against 26 confirmed. Searched queue drain 2.2% -> 12.7%, 56 rows. **Waves stripped 4 unsound verdicts of mine; `Agency`/Meridial was ACTIVE from a cron.** **NOT finished:** 398-421. Record: `docs/sessions/2026-08-28-registry-evening.md`.
