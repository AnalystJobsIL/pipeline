...
- **2026-08-31 `roles` (b)** — one employer double-listed and double-judged (`533`); 13 seen_ids named 2+ roles, one half mail-dead. Alias fold, intake + ledger (4/3 refuse); `same_role_twin` collapse; `description_blocker`, policy=exclude (operator 09-01). "~13 groups" = **3**. CI: `33444708674` failure (HANDOFF-cap race); master head `33445354707` **13/13 success**. **NOT finished:** `530`, `518`. Record: `docs/sessions/2026-08-31-roles-b.md`.
