...
- **2026-08-31 `jd-text`** — Indeed "auth-walled" falsified: the SERP `vjk=` pane fills **90 of 92** cached postings raw (`paid_only` + `_indeed_jd`, cap 8/night); marker bar + `_after_the_wall` fix the long-failing rows (14→11→4 structural). 104 credits; `468` applied, `421` closed 08-29. **NOT finished:** the 09-01 row, `443`-half, `513@registry`. Record: `docs/sessions/2026-08-31-jd-text.md`.
