...
- **2026-09-13 `classifier`** — the Israel gate believed a feed's location over the posting's own text, and 31 published verdicts named no contract. `stated_foreign_place` at gate and head: 36 of 6,691 cards flip, 0 wrong. Unknown cells now drain: 8 moved, 6 withdrawn. Ballerine YES x3. 51 calls, 0 BD. CI `34763188734` 15/16, red `infra`'s. **NOT finished:** `551`, `548`. Record: `docs/sessions/2026-09-13-classifier.md`.
