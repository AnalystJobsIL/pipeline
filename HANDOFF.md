...
- **2026-09-19 `infra`** — no Chromium in the digest, so jd-text's render rung latched `render-unavailable`: 0 rows a night. Playwright step (+28 s, budgets 358/360) + cap 5. `635`: one `health.one_night_reading` for both consumers, 0 of 109 skipped today. **NOT finished:** `638`, `604`. Record: `docs/sessions/2026-09-19-infra.md`.
