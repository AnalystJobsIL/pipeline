...
- **2026-09-01 `classifier`** — the 57-row dataset audit adjudicated: **21 withdrawn, 1 lifted (Parametrix), 7 refuted, 7 deferred**; three boundary records close `531`+`532`; one bump → **`v3.0f84ab84`**, rows 157→**137**. Caught first: superseded verdicts sorted by contract HASH — this bump would have served an older verdict for **336 jobs, 12 disagreeing** (`541`). **NOT finished:** the 09-02 proof, `542`-`544`. Record: `docs/sessions/2026-09-01-classifier.md`.
