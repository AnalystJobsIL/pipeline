...
| 2026-09-01 | company-intel | the first unattended digest on a headSha ⊇ the `display_name` commit logs `display_names=71 (+0/-0) divergent=56 sectors_folded=0` (±evidence drift) in step `firmo_drain` | | not yet due |
