...
- **2026-08-30 `roles` (b)** — three PUBLIC rows were wrong and nothing could remove them. `withdrawn` + `roles_retractions.jsonl`, three purge sources, meta `removed`, window **90**, `roles_archive.csv`; store copy **wrong 3 → 0**. Run **33320619890**: all jobs **success** except guard (inherited, fixed `a940ea4`) and mutation-gate 0 (`491@infra`). **BUILT, NOT YET PUBLISHED.** **NOT finished:** 496-500, 489. Record: `docs/sessions/2026-08-30-roles-b.md`.
