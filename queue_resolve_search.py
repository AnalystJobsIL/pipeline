...
def search_one(name):
    ...
    # A FREE DuckDuckGo rung stood here from 2026-09-11 to 2026-09-13 and was deleted on its
    # measurement: 0 answers for the 156 names this drain searched on 09-11 and 09-12, because
    # DuckDuckGo answered the first query of every shard with HTTP 202
    # (docs/decisions/2026-09-13-search-rung-deleted.md). The paid rung below is what the
    # drain was actually running on every one of those nights.
    urls = []
