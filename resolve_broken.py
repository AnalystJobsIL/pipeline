...
def _careers_url_via_serp(name):
    ...
    # (a free DuckDuckGo rung stood here 2026-09-11..13; on the self-heal runner it answered
    # one name in two days -- docs/decisions/2026-09-13-search-rung-deleted.md)
    try:
