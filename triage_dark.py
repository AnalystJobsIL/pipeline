...
# THE shared terminal list (docs/BACKLOG.md 47). The old inline copy matched bare
# `duplicate`; the shared token is `duplicate of` — measured on the real registry: the
# pool is 213 rows either way, zero moved.
